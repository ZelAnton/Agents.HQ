...
| TASK-0016 | P5 внутри-репо ∥ | orchestrator | **ready** | TASK-0015 | `../orchestrator/tasks/TASK-0016-p5-intra-repo-parallel.md` |
| TASK-0017 | P6 hardening/scale | orchestrator | queued | TASK-0016 | `../orchestrator/tasks/TASK-0017-p6-hardening-scale.md` |

Следующая готовая: **TASK-0016 (P5)** — зависимость (P4) выполнена.
