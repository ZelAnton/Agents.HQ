...
| TASK-0015 | P4 jj-интеграция + авто-land | orchestrator | **ready** | TASK-0014 | `../orchestrator/tasks/TASK-0015-p4-jj-integration-autoland.md` |
...
Следующая готовая: **TASK-0015 (P4)** — зависимость (P3) выполнена.
